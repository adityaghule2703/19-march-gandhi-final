    ...
    <CModal size="xl" visible={visible} onClose={onClose} alignment="center" scrollable>
      ...
      <CModalBody>
        ...
        <CRow className="mb-3">
          ...
          <CCol md={6}>
            ...
            <CFormCheck
              ...
              checked={formData.isSubdealerScheme}
              onChange={(e) => {
                setFormData({ 
                  ...formData, 
                  isSubdealerScheme: e.target.checked, 
        ...
        <div className="border rounded p-3 mb-3">
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <CFormSwitch
              label="Enable"
              checked={formData.params?.addonServicesAndAccessories?.isEnabled || false}
              onChange={(e) => {
                const isEnabled = e.target.checked;
                setFormData({
                  ...formData,
          ...
          {formData.params?.addonServicesAndAccessories?.isEnabled && (
            <>
              ...
              <CRow className="mb-3">
                <CCol md={12}>
                  <CFormCheck
                    ...
                    checked={formData.params.addonServicesAndAccessories.deductItemDiscount || false}
                    onChange={(e) => {
                      setFormData({
                        ...formData,
                        params: {
                          ...formData.params,
                          addonServicesAndAccessories: {
                            ...formData.params.addonServicesAndAccessories,
                            isEnabled: true,
              ...
              <div className="mb-3">
                ...
                <CInputGroup>
                  ...
                  >
                    ...
                    {headers
                      .filter(h => !formData.params.addonServicesAndAccessories.applicableHeaders.some(
                ...
                <div className="mt-2">
                  <div className="d-flex flex-wrap gap-2">
                    {formData.params.addonServicesAndAccessories.applicableHeaders.map((item) => (
                      <CBadge 
                        key={item.header} 
                        color="info"
                        className="d-flex align-items-center"
                  ...
                  <small className="text-muted">
                    {formData.params.addonServicesAndAccessories.applicableHeaders.length} header(s) selected
                  </small>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <CInputGroup>
                  ...
                  >
                    ...
                    {accessories
                      .filter(a => !formData.params.addonServicesAndAccessories.applicableAccessories.some(
                ...
                <div className="mt-2">
                  <div className="d-flex flex-wrap gap-2">
                    {formData.params.addonServicesAndAccessories.applicableAccessories.map((item) => (
                      <CBadge 
                        key={item.accessory} 
                        color="success"
                        className="d-flex align-items-center"
                  ...
                  <small className="text-muted">
                    {formData.params.addonServicesAndAccessories.applicableAccessories.length} accessory(ies) selected
                  </small>
                </div>
              </div>
              ...
              {formData.params.addonServicesAndAccessories.slabs?.map((slab, index) => (
                <CRow key={index} className="mb-2 align-items-end">
                  <CCol md={3}>
                    <label className="form-label">From (₹)</label>
                    <CFormInput
              ...
              {(!formData.params.addonServicesAndAccessories.slabs || 
                formData.params.addonServicesAndAccessories.slabs.length === 0) && (
                <p className="text-muted text-center mb-0">No slabs added. Click "Add Slab" to create one.</p>
              )}
            </>
          )}
                ...
                <CRow key={index} className="mb-2 align-items-end">
                  ...
                  <CCol md={4}>
                    ...
                    <CFormInput
                      type="number"
                      step="1"
                      value={item.amountPerUnit || item.amount}
                      onChange={(e) => {
      ...
      <CModalFooter>
        ...
        <CButton color="primary" onClick={onSubmit} disabled={formLoading}>
          {formLoading ? <><CSpinner size="sm" className="me-2" />Creating...</> : 'Create Scheme'}
        </CButton>
      </CModalFooter>
    </CModal>
  );
