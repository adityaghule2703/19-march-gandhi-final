...
//   // For Transfer Vehicles and Cancel operations - using CREATE permission
//   const canTransferVehicles = canCreateInPage(permissions, MODULES.STOCK_MOVEMENT, PAGES.STOCK_MOVEMENT.IDT_LIST);
  
//   // Also check using hasSafePagePermission for more granular control
//   const hasTransferPermission = hasSafePagePermission(
//     permissions, 
...
//   const canPerformTransfer = canTransferVehicles || hasTransferPermission;
...
//   // Fetch locations
//   const fetchLocations = async () => {
//     // Check if user has permission to view IDT List
//     if (!canViewIDTList && !canViewIDTHistory && !canViewIDTRequests) {
...
//       setIsLoadingVehicles(false);
//     }
//   }, [formData.sourceDatabase, formData.sourceLocationType, formData.sourceLocationId, canViewIDTList]);
...
//   // Trigger fetch when source location changes
//   useEffect(() => {
//     if (formData.sourceDatabase && formData.sourceLocationType && formData.sourceLocationId && canViewIDTList) {
//       fetchVehicles(1, DEFAULT_LIMIT, searchTerm);
//     }
//   }, [formData.sourceDatabase, formData.sourceLocationType, formData.sourceLocationId, canViewIDTList]);
...
//   const handleCancel = () => {
//     // Cancel button just navigates away, no permission needed for navigation
//     navigate('/dashboard');
//   };
...
//   // If user doesn't have permission to view IDT List, show access denied message
//   if (!canViewIDTList && !canViewIDTHistory && !canViewIDTRequests) {
//     return (
//       <div className="alert alert-danger m-3" role="alert">
//         You do not have permission to access Inter Dealer Transfer.
//       </div>
//     );
//   }
...
//                   <div className="form-footer">
//                     {/* Transfer Vehicles button - requires CREATE permission */}
//                     <button 
//                       type="submit" 
//                       className="submit-button" 
...
//                     {/* Cancel button - no permission needed for cancel/navigation */}
//                     <button 
//                       type="button" 
//                       className="cancel-button" 
//                       onClick={handleCancel} 
...
//                 {/* Vehicles Table - only shown if user has view permission */}
//                 {isSourceSelected && canViewIDTList && (
//                   <div className="vehicle-table mt-4 p-3">
//                     <h5>In-Stock Vehicle Details ({vehiclePagination.total} vehicles available)</h5>
...
//                 {isSourceSelected && vehiclePagination.total === 0 && !isLoadingVehicles && !searchTerm && canViewIDTList && (
//                   <div className="alert alert-info mt-4">
//                     No in-stock vehicles found at the selected source location.
//                   </div>
//                 )}
