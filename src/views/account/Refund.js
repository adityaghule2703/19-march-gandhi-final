...
// } from '@coreui/react';
// import CIcon from '@coreui/icons-react';
// import { cilPrint, cilCloudDownload, cilChevronLeft, cilChevronRight } from '@coreui/icons';
// import QRCode from 'qrcode';
// import tvsLogo from '../../assets/images/logo.png';
// import config from '../../config';
// import { numberToWords } from '../../utils/numberToWords';
...
//       pagination.docs.forEach(booking => {
//         if (!receiptsFetched[booking._id] && !loadingReceipts[booking._id]) {
//           fetchReceiptsForBooking(booking._id);
//         }
//       });
//     }
//   }, [pagination.docs, receiptsFetched, loadingReceipts]);
...
//       await fetchData(pagination.currentPage, pagination.limit, pagination.search);
...
//         <CCardHeader className='card-header d-flex justify-content-between align-items-center'>
//           <div className="d-flex align-items-center">
//             <span className="me-3 text-muted">Total Records: {pagination.total}</span>
//           </div>
//           <div className='d-flex'>
//             <CFormLabel className='mt-1 m-1'>Search:</CFormLabel>
//             <CFormInput
