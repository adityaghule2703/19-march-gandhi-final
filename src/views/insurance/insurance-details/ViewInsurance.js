                    ...
                    <CCardBody>
                      ...
                      <CRow className="mb-3">
                        ...
                        <CCol md={6}>
                          <div className="info-item">
                            <label className="form-label">Insurance Date</label>
                            <div className="info-value">{formatDate(insuranceData.insuranceDate)}</div>
                          </div>
                        </CCol>
                      </CRow>
                    </CCardBody>
                      ...
                      <CRow className="mb-3">
                        <CCol md={6}>
                          <div className="info-item">
                            ...
                            <div className="info-value">
                              <CBadge color={insuranceData.booking?.paymentType === 'FINANCE' ? 'info' : 'success'}>
                                {insuranceData.booking?.paymentType || 'N/A'}
                              </CBadge>
                            </div>
                          </div>
                        </CCol>
                        {insuranceData.booking?.paymentType === 'FINANCE' && (
                          <CCol md={6}>
                            <div className="info-item">
                              <label className="form-label">Financer Name</label>
                              <div className="info-value">{insuranceData.booking?.financerName || 'N/A'}</div>
                            </div>
                          </CCol>
                        )}
                      </CRow>
