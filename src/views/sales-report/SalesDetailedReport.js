...
//   // Permission checks for Sales Report module - Sales Detailed Report page
//   // Using PAGES.SALES_REPORT constants for page-level permissions
//   const canViewSalesDetailedReport = canViewPage(permissions, MODULES.SALES_REPORT, PAGES.SALES_REPORT.SALES_DETAILED_REPORT);
  
//   // Also check using hasSafePagePermission for more granular control
//   const hasViewPermission = hasSafePagePermission(
//     permissions, 
//     MODULES.SALES_REPORT, 
//     PAGES.SALES_REPORT.SALES_DETAILED_REPORT, 
//     ACTIONS.VIEW
//   );
  
//   // Combined permission check for view action
//   const canPerformView = canViewSalesDetailedReport || hasViewPermission;

//   // Fetch Model Wise Data with server-side pagination and search
//   const fetchModelWiseData = useCallback(async (page = 1, limit = DEFAULT_LIMIT, search = '') => {
//     // Check if user has permission to view sales detailed report
//     if (!canViewSalesDetailedReport && !hasViewPermission) {
//       setModelsError('You do not have permission to view sales detailed report');
//       setModelsLoading(false);
//       return;
//     }
...
//       setModelsLoading(false);
//     }
//   }, [canViewSalesDetailedReport, hasViewPermission]);

//   // Fetch Branch Wise Data with server-side pagination and search
//   const fetchBranchWiseData = useCallback(async (page = 1, limit = DEFAULT_LIMIT, search = '') => {
//     // Check if user has permission to view sales detailed report
//     if (!canViewSalesDetailedReport && !hasViewPermission) {
//       setBranchesError('You do not have permission to view sales detailed report');
//       setBranchesLoading(false);
//       return;
//     }
...
//     // Check if user has permission to view sales detailed report
//     if (!canViewSalesDetailedReport && !hasViewPermission) {
//       setExecutivesError('You do not have permission to view sales detailed report');
//       setExecutivesLoading(false);
//       return;
//     }
...
//   const fetchModelBookings = useCallback(async (modelId, page = 1, limit = 10) => {
//     // Check if user has permission to view sales detailed report
//     if (!canViewSalesDetailedReport && !hasViewPermission) return;
//     if (!modelId) return;
...
//       setModelsError('You do not have permission to view sales detailed report');
//     }
//   }, [fetchModelWiseData, fetchBranchWiseData, fetchExecutiveWiseData, canViewSalesDetailedReport, hasViewPermission]);
...
//   // If user doesn't have permission to view sales detailed report, show access denied message
//   if (!canViewSalesDetailedReport && !hasViewPermission && !modelsLoading && !branchesLoading && !executivesLoading) {
//     return (
//       <div className="alert alert-danger m-3" role="alert">
//         You do not have permission to view Sales Detailed Report.
//       </div>
//     );
//   }
...
//       {/* Summary Cards - Model Wise */}
//       {activeTab === 0 && modelsTotals && canPerformView && (
//         <CRow className="mt-3 mb-4">
//           <CCol md={3} sm={6} className="mb-3">
//             <CCard className="text-center border-primary">
//               <CCardBody>
...
//       {/* Summary Cards - Branch Wise */}
//       {activeTab === 1 && branchesTotals && canPerformView && (
//         <CRow className="mt-3 mb-4">
//           <CCol md={3} sm={6} className="mb-3">
//             <CCard className="text-center border-primary">
//               <CCardBody>
...
//       {/* Summary Cards - Executive Wise */}
//       {activeTab === 2 && executivesTotals && canPerformView && (
//         <CRow className="mt-3 mb-4">
//           <CCol md={3} sm={6} className="mb-3">
//             <CCard className="text-center border-primary">
//               <CCardBody>
