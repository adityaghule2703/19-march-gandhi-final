...
//       // Extract subdealer bookings from entries that are booking types
//       subdealerBookings = ledgerEntries
...
//     // Process ledger entries including ON_ACCOUNT_RECEIPT entries and their allocations
//     ledgerEntries.forEach((entry) => {
...
//           entry.receiptDetails.allocationBreakdown.forEach((allocation, index) => {
//             allTransactions.push({
//               type: 'allocation',
//               data: allocation,
//               parentReceipt: entry,
...
//         }
//       } 
//       // Process other types of entries (like regular ALLOCATION entries)
...
//         // Credit entries (receipts) DECREASE balance
...
//           // This is an allocation from receipt breakdown
//           credit = allocation.allocatedAmount || 0;
          
//           // For allocations from ON_ACCOUNT_RECEIPT, they are applied against bookings
//           // So they should increase balance (since they're payments against debits)
//           runningBalance += credit;
//           totalCredit += credit;
...
//           formattedDate = dateToFormat.toLocaleDateString('en-GB');
//         } else {
//           // Regular ALLOCATION entries can be credit or debit
//           credit = allocation.credit || 0;
//           debit = allocation.debit || 0;
...
//           ${transactionsWithBalance
//             .map(transaction => `
//               <tr class="${transaction.isAllocation ? 'allocation-row' : ''}">
//                 <td>${transaction.date}</td>
//                 <td>${transaction.description}</td>
//                 <td>${transaction.referenceNo}</td>
//                 <td class="text-right">${transaction.credit > 0 ? transaction.credit.toLocaleString('en-IN') : '0'}</td>
...
//       // Process ledger entries including ON_ACCOUNT_RECEIPT, ALLOCATION, and PENALTY_MODEL entries
//       ledgerEntries.forEach((entry) => {
//         // Process ON_ACCOUNT_RECEIPT entries and their allocations
//         if (entry.source === 'ON_ACCOUNT_RECEIPT') {
//           // Main receipt entry (credit entry)
...
//           });
//         }
//         // Process PENALTY_MODEL entries (penalty charges)
...
//           // Penalty entries INCREASE balance (debit)
...
//     // Process ledger entries including ON_ACCOUNT_RECEIPT, ALLOCATION, PENALTY_MODEL, and FINANCE_DISBURSEMENT
//     ledgerEntries.forEach((entry) => {
//       // Process ON_ACCOUNT_RECEIPT entries and their allocations
//       if (entry.source === 'ON_ACCOUNT_RECEIPT') {
//         // Main receipt entry (credit entry)
