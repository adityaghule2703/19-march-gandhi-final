...
//     pages: [
//       { 
//         name: "Subdealer Report", 
//         tabs: ["Sales Report", "Outstanding Report", "Booking Report"]
//       }
//     ],
//     availablePermissions: ["VIEW"]
//   },
...
//   "Subdealer Management": ["SUBDEALER MANAGEMENT", "SUBDEALER_MANAGEMENT"],
//   "Subdealer Account": ["SUBDEALER ACCOUNT", "SUBDEALER_ACCOUNT"],
//    "Subdealer Report": ["SUBDEALER REPORT", "SUBDEALER_REPORT"],
//   "User Management": ["USER MANAGEMENT", "USER_MANAGEMENT"]
// };
...
//   "Subdealer Report": {
//     "Subdealer Report": {
//       "VIEW": "Export Sales Report, Outstanding Report, and Booking Report for subdealers"
//     }
//   },
//   "User Management": {
//     "Create Role": {
...
const sidebarStructure = {
  ...
  "Purchase": {
    pages: [
      { name: "Stock Dashboard", tabs: null },
      { name: "Purchase Order Dashboard", tabs: null },
      { name: "Purchase Order Config", tabs: null },
      { name: "Purchase Config List", tabs: null },
      { name: "Inward Stock", tabs: null },
      { name: "Stock Alert", tabs: null },
      { 
        name: "Stock Verification", 
        tabs: ["PENDING VERIFICATION", "VERIFIED STOCK"]
      },
  ...
  "Sales": {
    pages: [
      ...
      { 
        name: "All Booking", 
        tabs: ["PENDING APPROVALS", "APPROVED", "PENDING ALLOCATED", "ALLOCATED", "REJECTED DISCOUNT", "CANCELLED BOOKING", "REJECTED CANCELLED BOOKING", "REJECTED LIST"]
      },
      { name: "Self Insurance", tabs: null },
      { name: "Delivery Challan", tabs: null },
      { name: "GST Invoice", tabs: null },
      ...
      { name: "Deal Form", tabs: null },
      { name: "Upload Deal Form & Delivery Challan", tabs: null },
      { name: "DUMMY Invoice", tabs: null }
    ],
    availablePermissions: ["CREATE", "UPDATE", "DELETE", "VIEW"]
  },
  "Sales Report": {
    pages: [
      { name: "Sales Dashboard", tabs: null },
      { name: "Claim Dashboard", tabs: null },
      { name: "Sales Detailed Report", tabs: null },
      { name: "Sales Person Wise", tabs: null },
      { name: "Periodic Report", tabs: null }
    ],
    availablePermissions: ["CREATE", "UPDATE", "DELETE", "VIEW"]
  ...
  "Account": {
    pages: [
      { name: "Dashboard", tabs: null },
      { name: "Claims", tabs: null },
      { 
        name: "Receipts", 
        tabs: ["CUSTOMER", "PAYMENT VERIFICATION", "COMPLETE PAYMENT", "PENDING LIST", "VERIFIED LIST"]
      },
      { name: "Receipts Dashboard", tabs: null },
      { name: "Report Dashboard", tabs: null },
      { name: "Report Disbursement", tabs: null },
      { name: "Debit Note", tabs: null },
      { name: "Refund", tabs: null },
      { 
        name: "Cancelled Booking", 
  ...
  "RTO": {
    pages: [
      ...
      { name: "HSRP Update On Vahan Portal", tabs: null },
      { name: "Report", tabs: null },
      { name: "RTO Invoice", tabs: null }
    ],
    availablePermissions: ["CREATE", "UPDATE", "DELETE", "VIEW"]
  ...
  "Masters": {
    pages: [
      ...
      { name: "Headers", tabs: null },
      { name: "Vehicles", tabs: null },
      { name: "Model Analytics", tabs: null },
      { name: "Minimum Booking Amount", tabs: null },
      { name: "Template List", tabs: null },
      { name: "Accessories", tabs: null },
      { name: "Colour", tabs: null },
      { name: "Documents", tabs: null },
      { name: "Wallpaper", tabs: null },
      { name: "Terms & Conditions", tabs: null },
      { name: "Offer", tabs: null },
      { name: "Attachments", tabs: null },
      { name: "Declaration", tabs: null },
  ...
  "IDT": {
    pages: [
      { name: "IDT List", tabs: null },
      { name: "IDT History", tabs: null },
      { name: "IDT Requests", tabs: null }
    ],
    availablePermissions: ["CREATE", "UPDATE", "DELETE", "VIEW"]
  },
  "Service Management": {
    pages: [
      { name: "Parts List", tabs: null },
      { name: "Labour List", tabs: null },
      { name: "Invoice List", tabs: null }
    ],
    availablePermissions: ["CREATE", "UPDATE", "DELETE", "VIEW"]
  },
  "HR Management": {
    pages: [
      { name: "Incentives List", tabs: null },
      { name: "Apply Incentive", tabs: null },
      { name: "Incentive Transactions", tabs: null }
    ],
    availablePermissions: ["CREATE", "UPDATE", "DELETE", "VIEW"]
  }
};
...
const moduleNameMap = {
  ...
  "Subdealer Report": ["SUBDEALER REPORT", "SUBDEALER_REPORT"],
  "User Management": ["USER MANAGEMENT", "USER_MANAGEMENT"],
  // ===== NEW MODULES MAPPINGS =====
  "IDT": ["STOCK MOVEMENT", "STOCK_MOVEMENT"],
  "Service Management": ["SERVICE MANAGEMENT", "SERVICE_MANAGEMENT"],
  "HR Management": ["HR MANAGEMENT", "HR_MANAGEMENT"]
};
...
const permissionDescriptions = {
  "Purchase": {
    ...
    // New Purchase pages
    "Stock Dashboard": {
      "CREATE": "Create stock dashboard reports",
      "VIEW": "View stock dashboard analytics",
      "UPDATE": "Edit dashboard settings",
      "DELETE": "Delete dashboard reports"
    },
    "Purchase Order Dashboard": {
      "CREATE": "Create purchase order reports",
      "VIEW": "View purchase order analytics",
      "UPDATE": "Edit purchase order settings",
      "DELETE": "Delete purchase orders"
    },
    "Purchase Order Config": {
      "CREATE": "Create purchase order configurations",
      "VIEW": "View purchase order configurations",
      "UPDATE": "Edit purchase order configurations",
      "DELETE": "Delete purchase order configurations"
    },
    "Purchase Config List": {
      "VIEW": "View purchase configuration list",
      "UPDATE": "Edit purchase configurations",
      "DELETE": "Delete purchase configurations"
    },
    "Stock Alert": {
      "CREATE": "Set stock alerts",
      "VIEW": "View stock alerts",
      "UPDATE": "Edit stock alert thresholds",
      "DELETE": "Delete stock alerts"
    }
  },
  "Sales": {
    "New Booking": {
  ...
  "Sales Report": {
    ...
    // New Sales Report pages
    "Sales Dashboard": {
      "CREATE": "Create sales dashboard reports",
      "VIEW": "View sales dashboard analytics",
      "UPDATE": "Edit dashboard settings",
      "DELETE": "Delete dashboard reports"
    },
    "Claim Dashboard": {
      "CREATE": "Create claim reports",
      "VIEW": "View claim dashboard analytics",
      "UPDATE": "Edit claim settings",
      "DELETE": "Delete claim records"
    },
    "Sales Detailed Report": {
      "CREATE": "Generate detailed sales reports",
      "VIEW": "View detailed sales reports",
      "UPDATE": "Edit report parameters",
      "DELETE": "Delete report records"
    }
  },
  "Quotation": {
    "Quotation": {
  ...
  "Account": {
    ...
    // New Account pages
    "Claims": {
      "CREATE": "Create new claims",
      "VIEW": "View claims",
      "UPDATE": "Edit claim details, Process claims",
      "DELETE": "Delete claims"
    },
    "Receipts Dashboard": {
      "CREATE": "Create receipt dashboard reports",
      "VIEW": "View receipt dashboard analytics",
      "UPDATE": "Edit dashboard settings",
      "DELETE": "Delete dashboard reports"
    },
    "Report Dashboard": {
      "CREATE": "Create financial report dashboards",
      "VIEW": "View financial report analytics",
      "UPDATE": "Edit report settings",
      "DELETE": "Delete report data"
    },
    "Report Disbursement": {
      "CREATE": "Create disbursement reports",
      "VIEW": "View disbursement reports",
      "UPDATE": "Edit disbursement settings",
      "DELETE": "Delete disbursement records"
    }
  },
  "Insurance": {
    "Dashboard": {
  ...
  "RTO": {
    ...
    "HSRP Update On Vahan Portal": {
      "CREATE": "Update HSRP status on Vahan Portal",
      "VIEW": "View HSRP update status",
      "UPDATE": "Edit HSRP details",
      "DELETE": "Delete HSRP records"
    }
  },
  "Fund Management": {
    "Cash Voucher": {
  ...
  "Masters": {
    ...
    // New Masters pages
    "Model Analytics": {
      "CREATE": "Create model analytics reports",
      "VIEW": "View model analytics",
      "UPDATE": "Edit analytics settings",
      "DELETE": "Delete analytics data"
    },
    "Wallpaper": {
      "CREATE": "Upload new wallpaper",
      "VIEW": "View wallpapers",
      "UPDATE": "Edit wallpaper settings",
  ...
  "Subdealer Report": {
    "Subdealer Report": {
      "VIEW": "Export Sales Report, Outstanding Report, and Booking Report for subdealers. Allows viewing and exporting subdealer-wise reports including sales, outstanding, and booking data across different date ranges."
    }
  },
  "User Management": {
    "Create Role": {
  ...
  // ===== NEW MODULES PERMISSION DESCRIPTIONS =====
  "IDT": {
    "IDT List": {
      "CREATE": "Create new IDT (Inter-Dealer Transfer) requests",
      "VIEW": "View IDT list and details",
      "UPDATE": "Edit IDT details",
      "DELETE": "Delete IDT records"
    },
    "IDT History": {
      "VIEW": "View IDT history and audit trail",
      "UPDATE": "Update IDT history records",
      "DELETE": "Delete history records"
    },
    "IDT Requests": {
      "CREATE": "Create new IDT requests",
      "VIEW": "View pending IDT requests",
      "UPDATE": "Approve/Reject IDT requests",
      "DELETE": "Delete IDT requests"
    }
  },
  "Service Management": {
    "Parts List": {
      "CREATE": "Add new parts, Import parts",
      "VIEW": "View parts list",
      "UPDATE": "Edit part details",
      "DELETE": "Delete parts"
    },
    "Labour List": {
      "CREATE": "Add new labour charges",
      "VIEW": "View labour list",
      "UPDATE": "Edit labour charges",
      "DELETE": "Delete labour records"
    },
    "Invoice List": {
      "CREATE": "Create service invoices",
      "VIEW": "View service invoices",
      "UPDATE": "Edit invoice details",
      "DELETE": "Delete service invoices"
    }
  },
  "HR Management": {
    "Incentives List": {
      "VIEW": "View incentives list",
      "UPDATE": "Edit incentive details",
      "DELETE": "Delete incentive records"
    },
    "Apply Incentive": {
      "CREATE": "Apply new incentives for employees",
      "VIEW": "View incentive application form",
      "UPDATE": "Edit incentive applications",
      "DELETE": "Delete incentive applications"
    },
    "Incentive Transactions": {
      "VIEW": "View all incentive transactions",
      "UPDATE": "Update transaction status",
      "DELETE": "Delete transaction records"
    }
  }
};
