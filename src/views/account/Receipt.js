...
//   // Function to generate receipt invoice HTML (separate from regular invoice)
...
//     // For first receipt, show full details
//     if (isFirstReceipt) {
//       const filteredPriceComponents = data.priceComponents.filter((comp) => {
//         const headerKey = comp.header?.header_key?.toUpperCase() || '';
...
//   // Keep the original generateInvoiceHTML function for other uses
//   const generateInvoiceHTML = (data) => {
//     const exchangeBrokerName = data.exchange ? data.exchangeDetails?.broker?.name || '' : '';
//     const exchangeVehicleNumber = data.exchange ? data.exchangeDetails?.vehicleNumber || '' : '';
...
//   // Function to generate receipt invoice HTML (separate from regular invoice)
//   const generateReceiptInvoiceHTML = (data, isFirstReceipt = true) => {
//     // ... existing generateReceiptInvoiceHTML code remains the same ...
//     // Keep the same function content as before
//     const exchangeBrokerName = data.exchange ? data.exchangeDetails?.broker?.name || '' : '';
//     const exchangeVehicleNumber = data.exchange ? data.exchangeDetails?.vehicleNumber || '' : '';
...
//   // Keep the original generateInvoiceHTML function for other uses
//   const generateInvoiceHTML = (data) => {
//     // ... existing generateInvoiceHTML code remains the same ...
//     // Keep the same function content as before
//     const exchangeBrokerName = data.exchange ? data.exchangeDetails?.broker?.name || '' : '';
//     const exchangeVehicleNumber = data.exchange ? data.exchangeDetails?.vehicleNumber || '' : '';
