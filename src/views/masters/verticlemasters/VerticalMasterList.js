...
const VerticalMasterList = () => {
  ...
  const showActionColumn = canUpdateVerticalMasters || canDeleteVerticalMasters || canCreateVerticalMasters;
                      ...
                      {showActionColumn && (
                        <CTableDataCell>
                          <CButton
                            ...
                            className='option-button btn-sm'
                            onClick={(event) => handleClick(event, vertical._id)}
                            disabled={!canUpdateVerticalMasters && !canDeleteVerticalMasters && !canCreateVerticalMasters}
                          >
                            <CIcon icon={cilSettings} />
                            Options
                          </CButton>
