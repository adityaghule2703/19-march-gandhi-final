...
if (canViewPage(userPermissions, MODULES.HR_MANAGEMENT, PAGES.HR_MANAGEMENT.INCENTIVE_TRANSACTIONS)) {
  ...
  if (canViewPage(userPermissions, MODULES.PURCHASE, PAGES.PURCHASE.INWARD_STOCK)) {
    purchaseItems.push({
      component: CNavItem,
      name: 'Purchase Config List',
      to: '/purchase-config-list',
    });
  }
  ...
  if (canViewPage(userPermissions, MODULES.SUBDEALER_REPORT, PAGES.SUBDEALER_REPORT.SUBDEALER_REPORT)) {
    subdealerReportItems.push({
      ...
      to: '/subdealer/subdealer-report',
    });
  }

  if (subdealerReportItems.length > 0) {
    _nav.push({
      component: CNavGroup,
      name: 'Subdealer Reports',
      icon: <CIcon icon={cilChartLine} customClassName="nav-icon" />,
...
//   // Only push items if user is SUPERADMIN and has permission
//   if (isSuperAdmin) {
//     if (canViewPage(userPermissions, MODULES.STOCK_MOVEMENT, PAGES.STOCK_MOVEMENT.IDT_LIST)) {
//       stockMovementItems.push({
//         component: CNavItem,
...
//   // Add Stock Movement group (only shows if isSuperAdmin is true and has items)
//   if (stockMovementItems.length > 0) {
//     _nav.push({
//       component: CNavGroup,
//       name: 'IDT',
...
//   if (canViewPage(userPermissions, MODULES.HR_MANAGEMENT, PAGES.HR_MANAGEMENT.APPLY_INCENTIVE)) {
//     hrManagementItems.push({
//       component: CNavItem,
...
//   if (canViewPage(userPermissions, MODULES.PURCHASE, PAGES.PURCHASE.STOCK_DASHBOARD)) {
//     purchaseItems.push({
//       component: CNavItem,
//       name: 'Stock Dashboard',
//       to: '/stock-dashboard',
...
//   if (canViewPage(userPermissions, MODULES.PURCHASE, PAGES.PURCHASE.PURCHASE_ORDER_DASHBOARD)) {
//     purchaseItems.push({
//       component: CNavItem,
//       name: 'Purchase Order Dashboard',
//       to: '/purchase-order-dashboard',
...
//   if (canViewPage(userPermissions, MODULES.PURCHASE, PAGES.PURCHASE.PURCHASE_ORDER_CONFIG)) {
//     purchaseItems.push({
//       component: CNavItem,
//       name: 'Purchase Order Config',
//       to: '/purchase-order-config',
...
//   if (canViewPage(userPermissions, MODULES.PURCHASE, PAGES.PURCHASE.PURCHASE_CONFIG_LIST)) {
//     purchaseItems.push({
//       component: CNavItem,
//       name: 'Purchase Config List',
//       to: '/purchase-config-list',
...
//   if (canViewPage(userPermissions, MODULES.PURCHASE, PAGES.PURCHASE.STOCK_ALERT)) {
//     purchaseItems.push({
//       component: CNavItem,
//       name: 'Stock Alert',
//       to: '/stock-alert',
...
//   if (canViewPage(userPermissions, MODULES.SALES_REPORT, PAGES.SALES_REPORT.SALES_DASHBOARD)) {
//     salesReportItems.push({
//       component: CNavItem,
//       name: 'Sales Dashboard',
//       to: '/sales-dashboard',
...
//   if (canViewPage(userPermissions, MODULES.SALES_REPORT, PAGES.SALES_REPORT.CLAIM_DASHBOARD)) {
//     salesReportItems.push({
//       component: CNavItem,
//       name: 'Claim Dashboard',
//       to: '/claim-dashboard',
...
//   if (canViewPage(userPermissions, MODULES.SALES_REPORT, PAGES.SALES_REPORT.SALES_DETAILED_REPORT)) {
//     salesReportItems.push({
//       component: CNavItem,
//       name: 'Sales Detailed Report',
//       to: '/sales-detailed-report',
...
//   if (canViewPage(userPermissions, MODULES.ACCOUNT, PAGES.ACCOUNT.CLAIMS)) {
//     accountItems.push({
//       component: CNavItem,
//       name: 'Claims',
//       to: '/claims',
...
//   if (canViewPage(userPermissions, MODULES.ACCOUNT, PAGES.ACCOUNT.RECEIPTS_DASHBOARD)) {
//     accountItems.push({
//       component: CNavItem,
//       name: 'Receipts Dashboard',
//       to: '/finance-receipts-dashboard',
...
//   if (canViewPage(userPermissions, MODULES.ACCOUNT, PAGES.ACCOUNT.REPORT_DASHBOARD)) {
//     accountItems.push({
//       component: CNavItem,
//       name: 'Report Dashboard',
//       to: '/finance-report-dashboard',
...
//   if (canViewPage(userPermissions, MODULES.ACCOUNT, PAGES.ACCOUNT.REPORT_DISBURSEMENT)) {
//     accountItems.push({
//       component: CNavItem,
//       name: 'Report Disbursement',
//       to: '/finance-disbursement',
...
//   if (canViewPage(userPermissions, MODULES.RTO, PAGES.RTO.VAHAN_PORTAL)) {
//     rtoItems.push({
//       component: CNavItem,
//       name: 'HSRP Update On Vahan Portal',
//       to: '/rto/vahanportal',
...
//   if (canViewPage(userPermissions, MODULES.MASTERS, PAGES.MASTERS.MODEL_ANALYTICS)) {
//     mastersItems.push({
//       component: CNavItem,
//       name: 'Model Analytics',
//       to: '/modelanalytics/model-analytics',
...
//   if (canViewPage(userPermissions, MODULES.MASTERS, PAGES.MASTERS.WALLPAPER)) {
//     mastersItems.push({
//       component: CNavItem,
//       name: 'Wallpaper',
//       to: '/wallpaper/wallpaper',
