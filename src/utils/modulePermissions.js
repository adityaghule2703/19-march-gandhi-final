...
export const MODULES = {
  ...
  SUBDEALER_MASTER: 'SUBDEALER MASTER',
  SUBDEALER_BOOKING: 'SUBDEALER BOOKING',
  SUBDEALER_MANAGEMENT: 'SUBDEALER MANAGEMENT', // Added this line
  SUBDEALER_ACCOUNT: 'SUBDEALER ACCOUNT',
  USER_MANAGEMENT: 'USER MANAGEMENT',
  ROLES: 'ROLES',
  USER: 'USER',
...
export const PAGES = {
  ...
  // Subdealer Management module pages - Added this section
  SUBDEALER_MANAGEMENT: {
...
export const TABS = {
  ...
  // Subdealer Management tabs - Added this section
  SUBDEALER_MANAGEMENT: {
    REJECTED_DISCOUNT: 'REJECTED DISCOUNT',
    CANCELLED_BOOKING: 'CANCELLED BOOKING',
    REJECTED_CANCELLED_BOOKING: 'REJECTED CANCELLED BOOKING'
...
export const getPageFromRoute = (routePath) => {
  const routeMap = {
    ...
    // Subdealer Management - Added this section
...
export const getTabsForPage = (page) => {
  const tabMap = {
    ...
    // Subdealer Management module - Added this section
