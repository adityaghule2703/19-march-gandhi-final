...
//   // Pagination states - matching StockList pattern
...
//   // Calculate pagination - matching StockList pattern
...
//   // Get current records for the page - matching StockList pattern
...
//   // Handle page change - matching StockList pattern
...
//           {/* Pagination Component - matching StockList style */}
...
//   const { permissions } = useAuth();
//   const { data, setData, filteredData, setFilteredData } = useTableFilter([]);
...
//       // Search through customer fields
//       const customerName = item.customer?.name?.toLowerCase() || '';
//       const customerAddress = item.customer?.address?.toLowerCase() || '';
//       const customerTaluka = item.customer?.taluka?.toLowerCase() || '';
//       const customerDistrict = item.customer?.district?.toLowerCase() || '';
//       const customerMobile = item.customer?.mobile1?.toLowerCase() || '';
      
//       // Search through quotation fields
//       const quotationNumber = item.quotation_number?.toLowerCase() || '';
      
//       return (
//         customerName.includes(searchTermLower) ||
//         customerAddress.includes(searchTermLower) ||
//         customerTaluka.includes(searchTermLower) ||
//         customerDistrict.includes(searchTermLower) ||
//         customerMobile.includes(searchTermLower) ||
//         quotationNumber.includes(searchTermLower)
//       );
//     });
