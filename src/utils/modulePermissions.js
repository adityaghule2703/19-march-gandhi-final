...
//   SUBDEALER_MANAGEMENT: 'SUBDEALER MANAGEMENT',
//   SUBDEALER_ACCOUNT: 'SUBDEALER ACCOUNT',
//   SUBDEALER_REPORT: 'SUBDEALER REPORT',
//   USER_MANAGEMENT: 'USER MANAGEMENT',
//   ROLES: 'ROLES',
//   USER: 'USER',
//   BUFFER_REPORT: 'BUFFER REPORT',
...
//   PAYMENT_VERIFICATION: 'PAYMENT VERIFICATION',
//   VERIFIED_LIST: 'VERIFIED LIST',
//   REJECTED_LIST: 'REJECTED LIST'  // Add this line
// },
...
//     '/subdealer-report': PAGES.SUBDEALER_REPORT.SUBDEALER_REPORT,
...
//     '/subdealer-report': MODULES.SUBDEALER_REPORT,
...
export const PAGES = {
  ...
  PURCHASE: {
    ...
    PURCHASE_ORDER_DASHBOARD: 'Purchase Order Dashboard',
    PURCHASE_ORDER_CONFIG: 'Purchase Order Config',
    PURCHASE_CONFIG_LIST: 'Purchase Config List',
  ...
  SALES_REPORT: {
    ...
    CLAIM_DASHBOARD: 'Claim Dashboard',
  ...
  RTO: {
    ...
    REPORT: 'Report',
    RTO_INVOICE: 'RTO Invoice',
    VAHAN_PORTAL: 'HSRP Update On Vahan Portal'
  },
  ...
  // Stock Movement module pages
  STOCK_MOVEMENT: {
    IDT_LIST: 'IDT List',
    IDT_HISTORY: 'IDT History',
    IDT_REQUESTS: 'IDT Requests'
  },

  // Service Management module pages
  SERVICE_MANAGEMENT: {
  ...
  // HR Management module pages
  HR_MANAGEMENT: {
    INCENTIVES_LIST: 'Incentives List',
    APPLY_INCENTIVE: 'Apply Incentive',
    INCENTIVE_TRANSACTIONS: 'Incentive Transactions'
  }
};
...
export const getPageFromRoute = (routePath) => {
  const routeMap = {
    ...
    '/rto-chassis': PAGES.PURCHASE.RTO_CHASSIS,
    // New Purchase routes
    '/stock-dashboard': PAGES.PURCHASE.STOCK_DASHBOARD,
    '/purchase-order-dashboard': PAGES.PURCHASE.PURCHASE_ORDER_DASHBOARD,
    '/purchase-order-config': PAGES.PURCHASE.PURCHASE_ORDER_CONFIG,
    '/purchase-config-list': PAGES.PURCHASE.PURCHASE_CONFIG_LIST,
    '/stock-alert': PAGES.PURCHASE.STOCK_ALERT,
    ...
    '/deal-form': PAGES.SALES.DEAL_FORM,
    '/upload-deal': PAGES.SALES.UPLOAD_DEAL_FORM,
    '/dummy-invoice': PAGES.SALES.DUMMY_INVOICE,
    
    // Sales Report
    '/sales-report': PAGES.SALES_REPORT.SALES_PERSON_WISE,
    '/periodic-report': PAGES.SALES_REPORT.PERIODIC_REPORT,
    // New Sales Report routes
    '/sales-dashboard': PAGES.SALES_REPORT.SALES_DASHBOARD,
    '/claim-dashboard': PAGES.SALES_REPORT.CLAIM_DASHBOARD,
    '/sales-detailed-report': PAGES.SALES_REPORT.SALES_DETAILED_REPORT,
    ...
    '/broker-payment': PAGES.ACCOUNT.BROKER_PAYMENT_VERIFICATION,
    '/receipt-report': PAGES.ACCOUNT.REPORT,
    '/dp-receipt': PAGES.ACCOUNT.DP_RECEIPT,
    '/downpayment-receipt': PAGES.ACCOUNT.DP_RECEIPT,
    // New Account routes
    '/claims': PAGES.ACCOUNT.CLAIMS,
    '/finance-receipts-dashboard': PAGES.ACCOUNT.RECEIPTS_DASHBOARD,
    '/finance-report-dashboard': PAGES.ACCOUNT.REPORT_DASHBOARD,
    '/finance-disbursement': PAGES.ACCOUNT.REPORT_DISBURSEMENT,
    ...
    '/rto/rto-report': PAGES.RTO.REPORT,
    '/rto/rto-invoice': PAGES.RTO.RTO_INVOICE,
    '/rto/vahanportal': PAGES.RTO.VAHAN_PORTAL,
    '/rto-invoice': PAGES.RTO.RTO_INVOICE,
    ...
    // Masters
    '/branch/branch-list': PAGES.MASTERS.LOCATION,
    '/branchauditlist/branch-audit-list': PAGES.MASTERS.BRANCH_AUDIT_LIST,
    '/headers/headers-list': PAGES.MASTERS.HEADERS,
    '/model/model-list': PAGES.MASTERS.VEHICLES,
    '/minimumbookingamount/minimum-booking-amount-list': PAGES.MASTERS.MINIMUM_BOOKING_AMOUNT,
    '/templateform/template-list': PAGES.MASTERS.TEMPLATE_LIST,
    ...
    '/subdealer/subdealer-report': PAGES.SUBDEALER_REPORT.SUBDEALER_REPORT,
    ...
    '/stock-movement': PAGES.STOCK_MOVEMENT.IDT_LIST,
    '/stock-movement-history': PAGES.STOCK_MOVEMENT.IDT_HISTORY,
    '/stock-movement-requests': PAGES.STOCK_MOVEMENT.IDT_REQUESTS,

    // Service Management routes
    '/service-management/parts': PAGES.SERVICE_MANAGEMENT.PARTS_LIST,
    '/service-management/labour': PAGES.SERVICE_MANAGEMENT.LABOUR_LIST,
    '/service-management/invoice': PAGES.SERVICE_MANAGEMENT.INVOICE_LIST,

    // HR Management routes
    '/hr-management/incentives': PAGES.HR_MANAGEMENT.INCENTIVES_LIST,
    '/hr-management/incentives/apply': PAGES.HR_MANAGEMENT.APPLY_INCENTIVE,
    '/hr-management/incentives/transactions': PAGES.HR_MANAGEMENT.INCENTIVE_TRANSACTIONS
  };
...
export const getModuleFromRoute = (routePath) => {
  const moduleMap = {
    ...
    '/rto-chassis': MODULES.PURCHASE,
    // New Purchase routes
    '/stock-dashboard': MODULES.PURCHASE,
    '/purchase-order-dashboard': MODULES.PURCHASE,
    '/purchase-order-config': MODULES.PURCHASE,
    '/purchase-config-list': MODULES.PURCHASE,
    '/stock-alert': MODULES.PURCHASE,
    ...
    '/deal-form': MODULES.SALES,
    '/upload-deal': MODULES.SALES,
    '/dummy-invoice': MODULES.SALES,
    
    // Sales Report
    '/sales-report': MODULES.SALES_REPORT,
    '/periodic-report': MODULES.SALES_REPORT,
    // New Sales Report routes
    '/sales-dashboard': MODULES.SALES_REPORT,
    '/claim-dashboard': MODULES.SALES_REPORT,
    '/sales-detailed-report': MODULES.SALES_REPORT,
    ...
    '/broker-payment': MODULES.ACCOUNT,
    '/receipt-report': MODULES.ACCOUNT,
    '/dp-receipt': MODULES.ACCOUNT,
    '/downpayment-receipt': MODULES.ACCOUNT,
    // New Account routes
    '/claims': MODULES.ACCOUNT,
    '/finance-receipts-dashboard': MODULES.ACCOUNT,
    '/finance-report-dashboard': MODULES.ACCOUNT,
    '/finance-disbursement': MODULES.ACCOUNT,
    ...
    '/rto/rto-report': MODULES.RTO,
    '/rto/rto-invoice': MODULES.RTO,
    '/rto/vahanportal': MODULES.RTO,
    '/rto-invoice': MODULES.RTO,
    ...
    // Masters
    '/branch/branch-list': MODULES.MASTERS,
    '/branchauditlist/branch-audit-list': MODULES.MASTERS,
    '/headers/headers-list': MODULES.MASTERS,
    '/model/model-list': MODULES.MASTERS,
    '/minimumbookingamount/minimum-booking-amount-list': MODULES.MASTERS,
    '/templateform/template-list': MODULES.MASTERS,
    ...
    '/subdealer/subdealer-report': MODULES.SUBDEALER_REPORT,
    ...
    // Stock Movement routes
    '/stock-movement': MODULES.STOCK_MOVEMENT,
    '/stock-movement-history': MODULES.STOCK_MOVEMENT,
    '/stock-movement-requests': MODULES.STOCK_MOVEMENT,

    // Service Management routes
    '/service-management/parts': MODULES.SERVICE_MANAGEMENT,
    '/service-management/labour': MODULES.SERVICE_MANAGEMENT,
    '/service-management/invoice': MODULES.SERVICE_MANAGEMENT,

    // HR Management routes
    '/hr-management/incentives': MODULES.HR_MANAGEMENT,
    '/hr-management/incentives/apply': MODULES.HR_MANAGEMENT,
    '/hr-management/incentives/transactions': MODULES.HR_MANAGEMENT
  };
